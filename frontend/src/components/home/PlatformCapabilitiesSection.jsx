    ...
    <section className="hp-section">
      ...
      <div className="platform-grid">
        <Link to="/news" className="platform-card platform-card--news">
          ...
          <div className="platform-card-desc">Curated football news with analytical context.</div>
        ...
        <Link to="/learn" className="platform-card platform-card--ground">
          ...
          <div className="platform-card-desc">Methodology deep dives and model transparency.</div>
          <div className="platform-card-tags">
        ...
        <Link to="/games" className="platform-card platform-card--games">
          ...
          <div className="platform-card-title">Sports Arcade</div>
          <div className="platform-card-desc">Interactive prediction challenges and mini games.</div>
          <div className="platform-card-tags">
      ...
      {analyticsTerm.term && (
        <Link to="/learn" style={{ textDecoration: "none", color: "inherit", display: "block", marginTop: 12 }}>
          <div className="hp-card" style={{ display: "flex", alignItems: "center", gap: 14, padding: "12px 16px",
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontFamily: "var(--font-display)", fontSize: 11, fontWeight: 700, color: "#e8f0ff" }}>{analyticsTerm.term}</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 10, color: "#4a6a8a", lineHeight: 1.4,
                whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{analyticsTerm.definition}</div>
            </div>
            <div style={{ fontFamily: "var(--font-mono)", fontSize: 9, color: "#4a6a8a", whiteSpace: "nowrap" }}>Learn →</div>
          </div>
        </Link>
      )}
    </section>
