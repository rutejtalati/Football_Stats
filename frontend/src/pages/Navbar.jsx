...
const NAV_ITEMS = [
  ...
  { to: "/learn",                      label: "How It Works", Icon: Icons.GroundZero, color: "#fbbf24", secondary: true },
  { to: "/games",                      label: "Games",       Icon: Icons.Games,      color: "#fb923c", secondary: true },
];

const FPL_ITEMS = [
  { to: "/player/fpl",         label: "Player Insight",     desc: "Premier League player rankings"    },
...
const FPL_PATHS = [
  "/player/fpl", "/best-team", "/squad-builder", "/gameweek-insights", "/fpl-table",
